...
describe('Radio', () => {
  ...
  it('disabled', done => {
    vm = createVue({
      template: `
      <el-radio v-model="radio" label="a" disabled>
      </el-radio>
    `,
      data() {
        return {
  ...
  describe('Radio group', () => {
      ...
      vm = createVue({
        template: `
          <el-radio-group v-model="radio">
            <el-radio-button :label="3" ref="radio1">备选项</el-radio-button>
            <el-radio-button :label="6" ref="radio2">备选项</el-radio-button>
            <el-radio-button :label="9" ref="radio3">备选项</el-radio-button>
          </el-radio-group>
        `,
        data() {
          return {
    ...
    describe('Radio Button', () => {
      ...
      it('size', done => {
        ...
        setTimeout(_ => {
          expect(vm.$el.querySelectorAll('.el-radio-button--large').length).to.equal(3);
          done();
        }, 10);
      });
    });
